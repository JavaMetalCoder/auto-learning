...
// Aggiungi QUESTA route all'inizio, dopo const users = [...]

app.get('/', (req, res) => {
    res.json({
        messaggio: '🚀 Server Express funzionante!',
        istruzioni: 'Usa gli URL qui sotto per testare',
        routes_disponibili: [
            'GET /users/1',
            'GET /users/2', 
            'GET /users/999 (per testare 404)',
            'GET /users/2/posts/123',
            'GET /test-status/200',
            'GET /test-status/404'
        ]
    });
